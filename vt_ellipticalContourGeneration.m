function  [PV_N, currTubeSectionDiameterCells_SegmentCounter]  = vt_ellipticalContourGeneration(PV_N, numSections, totalTubeLengthInCells, tubeCummSectionLength, ellipseAxisLenInfo, boundaryInterpolation, tubeStart, gridCellTypes, ds)
