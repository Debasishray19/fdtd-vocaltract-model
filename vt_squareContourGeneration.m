function  [PV_N, currTubeSectionDiameterCells_SegmentCounter]  = vt_squareContourGeneration(PV_N, numSections, totalTubeLengthInCells, tubeSquareLenInCells, tubeCummSectionLength, boundaryInterpolation, tubeStart, gridCellTypes, ds)
