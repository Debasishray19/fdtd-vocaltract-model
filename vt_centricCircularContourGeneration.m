function  [PV_N, currTubeSectionDiameterCells_SegmentCounter]  = vt_centricCircularContourGeneration(PV_N, numSections, totalTubeLengthInCells, tubeSectionDiameterCells, tubeCummSectionLength, boundaryInterpolation, tubeStart, gridCellTypes, ds)
    ...
    for tubeLenCellsCount = 1:totalTubeLengthInCells
        ...
        tubeUpperY = startY-currGetRadius-1;
        tubeLowerY = startY+currGetRadius+1;
